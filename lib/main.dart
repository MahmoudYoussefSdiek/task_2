...
import 'package:task_2/animation_provider.dart';
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: Column(
          ...
          children: const [WaveBackground()],
        ),
        floatingActionButton: Consumer<AnimationProvider>(
          builder: (context, provider, child) {
            return FloatingActionButton(
              ...
              child: Icon(provider.flag ? Icons.pause : Icons.play_arrow),
            );
          },
        ),
      ),
...
class _WaveBackgroundState extends State<WaveBackground>
  ...
  Widget build(BuildContext context) {
    return Consumer<AnimationProvider>(
      builder: (context, provider, child) {
        provider.flag ? _controller.repeat() : _controller.stop();
